...
Observamos que **no** se nos muestra ningun **BadChar**, esto si en el momento de crear la [lista bytearray](http://localhost:4000/tryhackme/Brainpan1/#4-lista-de-badchars-con-mona) omitimos el **BadChar** `"\x00"`, caso contrario se te debería listar el mismo por pantalla.
